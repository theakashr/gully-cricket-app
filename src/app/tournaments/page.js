                      ...
                      <div className="w-full flex flex-col items-center">
                         ...
                         <svg className="w-full max-w-[480px] h-[160px]" viewBox="0 0 500 180">
                            ...
                            {analyticsData.inn1.wicketsPerOver.map((w, idx) => (
                               <circle key={`w-inn1-${idx}`} cx={30 + w.over*wormStepX} cy={160 - (w.runsAtWicket/wormMaxRuns)*140} r="3.5" className="fill-red-600 stroke-white" strokeWidth="1"/>
                            ))}
                                  ...
                                  <g key={`bars-${over}`}>
                                     ...
                                     {index < inn1BowledOvers && (
                                        <>
                                          ...
                                          {inn1Wkts.length > 0 && (
                                             <circle cx={posX + 2 + barW/2} cy={145 - inn1Height} r="2.5" className="fill-red-600 stroke-white" strokeWidth="0.5"/>
                                          )}
                                        </>
                                     )}
