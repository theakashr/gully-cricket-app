                    ...
                    >
                      <div className="p-6">
                        ...
                        {t.players.length > 0 ? (
                            ...
                            {t.players.map(p => (
                              <div key={p.id} className="bg-white border border-slate-200/80 shadow-sm rounded-xl p-3 flex justify-between items-center group hover:border-slate-300 transition-all">
                                ...
                                <button 
                                  ...
                                  className="text-slate-300 hover:text-red-600 opacity-100 md:opacity-0 group-hover:opacity-100 transition-all p-1"
                                >
                                  <Trash2 size={14} />
                                </button>
                              </div>
                          ...
                          <p className="text-slate-400 text-sm mb-6 text-center font-medium">No players in the squad yet.</p>
                        )}
